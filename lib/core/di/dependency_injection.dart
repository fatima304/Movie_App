...
import '../../features/movies/presentation/manager/cubit/movies_list_cubit.dart';
import '../../features/movies/presentation/manager/cubit/movie_details_cubit.dart';
...
Future<void> setupServiceLocator() async {
  ...
  getIt.registerFactory<MoviesListCubit>(
    () => MoviesListCubit(getIt<MovieRepository>()),
  );

  getIt.registerFactory<MovieDetailsCubit>(
    () => MovieDetailsCubit(getIt<MovieRepository>()),
  );
